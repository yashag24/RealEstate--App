...
const PropertyListings = () => {
    ...
    }, [route.params?.query, city, fetchProperties]);
                    ...
                    : (
                        <View style={{ width: '100%' }}>
                            ...
                            <Text style={styles.headDetail}>
                                {properties.length} results | Property from {city === "" ? "All Cities" : city}{" "}
                            ...
                            <View style={styles.propertyContainer}>
                                ...
                                {properties.slice().reverse().map((property) => {
                                    ...
                                    const isCityValid =
                                        !filters.city ||
                                        (typeof filters.city === "string" && property.city?.toLowerCase() === filters.city.toLowerCase());

                                    const isMatch = isBudgetValid && isAreaValid && isBedroomValid && isTypeValid && isCityValid;
...
const styles = StyleSheet.create({
    ...
    propertyCardWrapper: {
        ...
        alignItems: 'center',
        width: '100%',
        marginBottom: 20, // replaces vertical gap
    },
    linkWrapper: {
        width: '100%',
    },
    ...
    propertyContainer: {
        ...
        flexWrap: "wrap",
        justifyContent: 'flex-start',
        // use margin on child to create spacing
    },
});
